...
function Init(Signal) {
    ...
    MaterialInfo = {
        ...
        "Kd": new Float32Array([0.6, 0.6, 0.6]), //Diffuse
        "Ks": new Float32Array([0, 0, 0]), //Specular
        "Shininess": 1
    }
...
function LoadData(Signal) {
    ...
    var P2 = new LoadImagePack({
        "ImagePaths": ["/Images/Brick2.png","/Images/NormalMap.png"]
    })
    ...
    var P3 = new CPack({
        ...
        "FX": function () {
            ...
            TangentBuffer = GLGame2.CreateVBO(gl, Mesh.tangents);
            GLGame2.BindVertexProps(gl, Locs["TangentProp"])
            ...
            NormalTexBuffer = gl.createTexture();
            gl.bindTexture(gl.TEXTURE_2D, NormalTexBuffer);
            gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, false);
            gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
            gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
            gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
            ...
            texLocs = [ gl.getUniformLocation(GPUProgram,"tex"),
                    gl.getUniformLocation(GPUProgram,"normalTex")]
