...
var MatCameraAttr, LightAttrs, MaterialAttr, EyeAttr, NofLightAttr,FogAttr;
var Cam;
var VBO;

var LightInfo, MaterialInfo, NumberOfLights=2,Fog;
...
function LoadData(Signal) {
    ...
    var P3 = new CPack({
        ...
        "FX": function () {
            ...
            FogAttr = {};
            for(var a in Fog){
                FogAttr[a] = gl.getUniformLocation(GPUProgram,"Fog."+a);
            }

            for (var i = 0; i < NumberOfLights; i++) {
                var LightAttr = {
                    "Pos":gl.getUniformLocation(GPUProgram, 'Lights['+i+'].Pos'),
                    "Li":gl.getUniformLocation(GPUProgram, 'Lights['+i+'].Li')
                };                
...
function Render() {
    ...
    gl.uniform4fv(FogAttr.Color,Fog.Color);
    gl.uniform1f(FogAttr.MaxDist,Fog.MaxDist);
    gl.uniform1f(FogAttr.MinDist,Fog.MinDist);
